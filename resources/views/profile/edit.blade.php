...
@section('content')
    <div class="row">
        <div class="col-xl-4 col-lg-4 ">
            ...
            <div class="card">
                <div class="card-body">
                    <form id="image-uplaod" role="form" autocomplete="off" method="post" action="{{ route('update-image') }}" enctype="multipart/form-data">
                        @csrf
                        <div style="margin-bottom: 10px;">
                            <div class="circle" style="align-items: center; margin: auto;">
                                <img class="profile-pic" src="{{asset((Auth::user()->img==null || Auth::user()->img=='') ? 'https://d30y9cdsu7xlg0.cloudfront.net/png/138926-200.png' : Auth::user()->img)}}">
                            </div>
        ...
        <div class="col-xl-8 col-lg-8" id="after-avater">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="update-info" role="form" autocomplete="off" action="{{ route('update-info') }}" method="post">
                        @csrf
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="email" value="{{ Auth::user()->email }}" placeholder="example@address.com" required disabled>
                                </div>
                                @error('email')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
        ...
        <div class="col-xl-12 col-lg-12 ">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="update-password" role="form" autocomplete="off" action="{{ route('update-password') }}" method="post">
                        @csrf
                        <div class="row clearfix">
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
